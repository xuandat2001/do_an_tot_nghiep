...
<head>
    ...
    <link rel="stylesheet" href="giao_dien/news/style.css">
</head>
<body>
    @extends('master')
    @section('content')
<div class="content-top">
        <div class="container">
            ...
            <p><a href="../index.html">KOI BENTO - Nhà hàng Nhật></a><span>Tin TỨC</span></p>
        </div>
    </div>
                ...
                <div class="col-xl-8 col-md-8 col-12">
                    <div class="new-header">
                        ...
                        <div class="text-content">
                            ...
                            <a href="new1/index.html" class="btn btn-outline-danger">READ MORE</a>
                        </div>
                    </div>
                    <div class="new-center">
                        ...
                        <div class="text-content">
                            ...
                            <a href="new2/index.html" class="btn btn-outline-danger">READ MORE</a>
                        </div>
                    </div>
