...
<head>
    ...
    <title>BIG_BENTO</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css">
    <link rel="stylesheet" href="giao_dien/show/big_bento/style.css">
</head>
<body>
    @extends('master')
    @section('content')
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6">
                            ...
                            <div class="row child1">
                                <div class=" col-xl-7 ">    
                                    <a href="#">
                                    <img src="giao_dien/show/big_bento/img/suon.png" style="margin:50px 0" alt="" width="100%" height="auto">
                                    </a>
                                </div>
